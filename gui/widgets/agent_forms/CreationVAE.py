...
class CreationVAE(tk.Frame):
    ...
    def __init__(self, parent, scrollbar):
        ...
        self.decoder_combobox.grid(row=1, column=1, pady=(5, 15), padx=5, sticky="nsew")
        ...
        self.vfe_lr_label.grid(row=2, column=0, pady=5, padx=5, sticky="nse")
        scrollbar.bind_wheel(self.vfe_lr_label)

        self.vfe_lr_entry = Entry(self.hyper_parameters, valid_input="float", help_message="0.0001")
        self.vfe_lr_entry.grid(row=2, column=1, pady=5, padx=5, sticky="nsew")
        scrollbar.bind_wheel(self.vfe_lr_entry)
